...
import com.example.zsk.utilsdemotwo.other.BarChartBean;
import com.example.zsk.utilsdemotwo.other.CombineChart;
...
public class CombineChartActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        data.add(new BarChartBean("1", 1003, 500, 600));
        data.add(new BarChartBean("2", 890, 456, 123));
        data.add(new BarChartBean("3", 456, 741, 654));
        data.add(new BarChartBean("4", 258, 951, 12));
        data.add(new BarChartBean("5", 863, 45, 99));
        data.add(new BarChartBean("6", 357, 235, 456));
        data.add(new BarChartBean("7", 452, 321, 55));
        data.add(new BarChartBean("8", 654, 555, 666));
        data.add(new BarChartBean("9", 321, 333, 222));
        data.add(new BarChartBean("10", 846, 111, 444));
