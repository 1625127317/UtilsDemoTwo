...
public class ColorTemplate {
    ...
    public static final int[] LIBERTY_COLORS = {
            Color.rgb(0, 197, 205), Color.rgb(148, 212, 212), Color.rgb(136, 180, 187),
            Color.rgb(118, 174, 175), Color.rgb(42, 109, 130)
    };
    public static final int[] JOYFUL_COLORS = {
            Color.rgb(25, 25, 112), Color.rgb(254, 149, 7), Color.rgb(254, 247, 120),
    ...
    public static final int[] COLORFUL_COLORS = {
            Color.rgb(255, 106, 106), Color.rgb(255, 102, 0), Color.rgb(245, 199, 0),
            Color.rgb(106, 150, 31), Color.rgb(179, 100, 53)
    };
    public static final int[] VORDIPLOM_COLORS = {
            Color.rgb(60, 179, 113), Color.rgb(205, 201, 201), Color.rgb(154 ,205 ,50),
            Color.rgb(140, 234, 255), Color.rgb(255, 140, 157)
    };
    public static final int[] MATERIAL_COLORS = {
            rgb("#20B2AA"), rgb("#BEBEBE"), rgb("#e74c3c"), rgb("#3498db")
    };
